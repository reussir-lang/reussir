...
{- |
Module      : Reussir.Core2,Semi.Mangle
...
-}
module Reussir.Core2.Semi.Mangle where
...
-}
manglePathWithArgs :: Path -> [Type] -> TB.Builder
manglePathWithArgs path [] = mangle path
manglePathWithArgs path args =
    TB.fromChar 'I' <> mangle path <> foldMap mangle args <> TB.fromChar 'E'
