module Test.Reussir.Core2.Class (tests) where
...
testSingleInheritance = runEff . runPrim $ do
    dag <- newDAG
    let cA = mkClass "A"
        cB = mkClass "B"
        cC = mkClass "C"
...
testMultipleInheritance = runEff . runPrim $ do
    dag <- newDAG
    let cA = mkClass "A"
        cB = mkClass "B"
        cC = mkClass "C"
...
testDiamondInheritance = runEff . runPrim $ do
    dag <- newDAG
    let cA = mkClass "A"
        cB = mkClass "B"
        cC = mkClass "C"
...
testMeetClass = runEff . runPrim $ do
    dag <- newDAG
    let cA = mkClass "A"
        cB = mkClass "B"
        cC = mkClass "C"
...
testMeetBound = runEff . runPrim $ do
    dag <- newDAG
    let cA = mkClass "A"
        cB = mkClass "B"
        cC = mkClass "C"
